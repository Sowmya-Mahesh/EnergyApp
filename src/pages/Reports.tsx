 ...
 */}
      {/* Table or Cards */}
      {isMobile ? (
        paginatedRecords.map((item) => <EnergyCard key={item.id} record={item} formatDate={formatDate} />)
      ...
      <Pagination loading={loading} totalPages={totalPages} page={page} handlePage={handlePage} error={error} />
    </div>
  );
};
